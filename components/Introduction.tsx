  ...
  return (
    <div id="intro" className='grid md:grid-cols-4 md:grid-rows-2 gap-6 p-[50px] md:p-[170px]' >
        ...
        <div className="col-start-1 row-start-3 md:col-start-3 md:col-ends-3 md:row-start-1 bg-gray-200 rounded-2xl">
          ...
          <p className=' mx-4 text-[#555]'>Im a second grade student from SMK TI Bali Global , i am driven by a passion for a programming and a thirst for knowledge </p>
          <br />
          <br />
          <br />
        ...
        <div className='col-start-1 row-start-4 md:col-start-4 md:col-ends-4 md:row-start-1'>
          ...
          <p className='mx-4 text-[#555]'>I am in a journey to refine my skills in crafting front-end designs and im poised to embrace a continuous learning journey.</p>
          <br />
          <br />
          <br />
          <span className='border-b-2 border-black relative left-5 bottom-4'> View More</span>
